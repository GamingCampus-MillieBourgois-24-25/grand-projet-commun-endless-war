...
public class Axe : Attack
{
    ...
    {
        float angleThisFrame = skillSettings.Speed * projectileSpeedMultiplier * Time.deltaTime;
        ...
        if (rotationAngle >= skillSettings.MaxRotation * rangeMultiplier * projectileSpeedMultiplier)
        {
            DestroyAttack();
        }
    }
